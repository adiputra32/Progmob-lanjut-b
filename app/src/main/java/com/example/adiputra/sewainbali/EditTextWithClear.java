    ...
    private void init() {
        ...
        setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                // if the drawable is on the "end" of text [2] 0-1-2-3.
                if ((getCompoundDrawablesRelative()[2] != null)) {
                    float clearButtonStart; // Used for LTR(left-to-right) languages
                    float clearButtonEnd;  // Used for RTL(right-to-left) languages
