...
public class EditTextWithPaste extends AppCompatEditText {
    Drawable mClearButtonImage;

    public EditTextWithPaste(Context context) {
        super(context);
        init();
    }
    public EditTextWithPaste(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    public EditTextWithPaste(Context context,
